...
unstandardizedMusicDf = read_csv("FrostData/unstandardizedMusicDf.csv")
...
```{r}
ggplot(unstandardizedMusicDf, aes(x = musicalComplexity))+ geom_histogram(binwidth = 5) +labs(title = "Distribution of Musical Complexity Scores")
```
...
```{r}
temp = artistDf %>% select(Name, Label) %>% distinct()
...
```{r}
ggplot(fullCompleteMetric, aes(y = pop1, x = Label)) + geom_violin(aes(fill = Label), trim = FALSE) + labs(title = "Maroon 5's Song Popularity by Album",x = "Label", y = "Standardized Popularity") + geom_jitter() + coord_flip()

ggplot(fullCompleteMetric, aes(y = nonBandMemberWriters, x = Label)) + geom_violin(aes(fill = Label), trim = FALSE) + labs(title = "Maroon 5's Outside Influence by Album",x = "Label", y = "Number of Non-Bandmember Writers") + geom_jitter()+ coord_flip()

ggplot(fullCompleteMetric, aes(y = totalComplexity, x = Label)) + geom_violin(aes(fill = Label), trim = FALSE) + labs(title = "Maroon 5's Song Complexity by Album", x = "Label", y = "Standardized Total Complexity") + geom_jitter()+ coord_flip()
...
```{r}
ggplot(fullCompleteMetric, aes(x= totalComplexity, y =nonBandMemberWriters )) + geom_point(aes(color = Label, size = pop1)) + labs(title= "Number of Non-Band Member Writers, Total Complexity, and Popularity by Record Label", x = "Standardized Total Complexity", y = "Number of Non-Bandmember Writers", size = "Standardized Popularity")
