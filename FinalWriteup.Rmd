...
```{r}
popGraph = ggplot(fullCompleteMetric, aes(y = pop1, x = Label)) + geom_violin() + labs(x = "Label", y = "Standardized Popularity") + geom_jitter() + coord_flip()

infGraph = ggplot(fullCompleteMetric, aes(y = nonBandMemberWriters, x = Label)) + geom_violin() + labs(x = "Label", y = "Number of Non-Bandmember Writers") + geom_jitter()+ coord_flip()

compGraph = ggplot(fullCompleteMetric, aes(y = totalComplexity, x = Label)) + geom_violin() + labs(x = "Label", y = "Standardized Total Complexity") + geom_jitter()+ coord_flip()
